...
-- Placeholder so this file builds. Phase A part 2 populates with real
-- compatibility lemmas (statements + sorry bodies) over the concrete
-- HasVTy / HasCTy / Ctx arithmetic.
