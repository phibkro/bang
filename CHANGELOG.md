...
- **wasm** — wCustomUpdate_comm — the custom clause-service lockstep lemma (#62 slice 3a) (`ff52aaf`)
- **wasm** — compile_forward_sim UNCONDITIONAL over custom effects — drop CustomFree (#62 slice 3) (`9593e7e`)
