...
_Generated by `tools/gen-proof-state.py --lean-root <…>`. Proof-state for Bang tree `tree:da19cdb2659474ccc925064a5249cde26b83431d`; inputs `proof-input:dd84900cdbfb8b5775e8f8eed8fe0fb6f3a865945a94a0d014e97c340c19ece4`._
...
The lead now moves to `PATH-resource-contract-tracer`: the effect-description axis is executable,
while resource quantities remain kernel-only behind the surface checker's `ω` default. The next
consumer is a one-shot permit whose accepted/refused programs must drive the smallest opt-in value
quantity; concrete grade-0 Wasm evidence and a queryable contract/evidence card are exit gates.
