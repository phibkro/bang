...
| **Kernel-as-substrate survey** (verified semantic substrate · profile ladder = λ→-typed FLOOR + erased ceiling × effect-rows (kernel has NO ∀, IR.lean:229) · RISC-V-profile naming · adequacy transfer condition · STLC/IMP tracer scoped) | `docs/notes/kernel-substrate-survey.md` |
