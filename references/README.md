...
_Generated by `tools/refs.py build`. **97** entries · **64** on-disk · **42** facet-tagged. Full records: `references/index.json`. Query: `just refs <term>`._

- **topics:** capability-safety (5), calculation (4), multishot (4), graded-types (3), effect-algebra (3), env-semantics (3), lr (3), wasmfx (3), surface-syntax (3), parsing (2), agentic-proving (2), verified-semantics (2), effect-handlers (2), cbpv (2), conformance-profiles (2), compilation (1), counterexample (1), lemma-discovery (1), stm (1), verified-compilation (1), effects (1), module-system (1), verified-typechecker (1), iris (1)
- **roles:** frontier (15), substrate (9), confirmed-sota (6), census-neighbour (4), foundational (3), shape-anchor (2), recipe (1), speculative (1), closest-prior-art (1)
