...
_Generated by `tools/refs.py build`. **125** entries · **65** on-disk · **70** facet-tagged. Full records: `references/index.json`. Query: `just refs <term>`._

- **topics:** grades (8), dependent-effects (7), refinement-types (7), capability-safety (6), cbpv (5), graded-types (4), calculation (4), multishot (4), memory (4), effect-algebra (3), env-semantics (3), lr (3), wasmfx (3), surface-syntax (3), verified-semantics (3), agentic-proving (3), monomorphization (3), parsing (2), effect-handlers (2), conformance-profiles (2), compilation (1), metatheory (1), counterexample (1), lemma-discovery (1), stm (1), verified-compilation (1), effects (1), module-system (1), verified-typechecker (1), iris (1)
- **roles:** frontier (18), confirmed-sota (13), substrate (11), census-neighbour (7), foundational (5), shape-anchor (4), recipe (3), closest-prior-art (2), speculative (1), grade-family-I (1), grade-family-U (1), grade-family-T (1), grade-family-N (1), grade-family-S (1), grade-family-R (1)
- **on-disk by hop:** adjacent (28), 1-kernel (14), 2-calcvm (10), 3-lr (7), 4-wasmfx (6)
