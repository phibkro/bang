...
_Generated by `tools/refs.py build`. **123** entries · **64** on-disk · **68** facet-tagged. Full records: `references/index.json`. Query: `just refs <term>`._

- **topics:** grades (8), dependent-effects (7), refinement-types (7), capability-safety (5), cbpv (5), graded-types (4), calculation (4), multishot (4), memory (4), effect-algebra (3), env-semantics (3), lr (3), wasmfx (3), surface-syntax (3), agentic-proving (3), monomorphization (3), parsing (2), verified-semantics (2), effect-handlers (2), conformance-profiles (2), compilation (1), counterexample (1), lemma-discovery (1), stm (1), verified-compilation (1), effects (1), module-system (1), verified-typechecker (1), iris (1)
- **roles:** frontier (16), confirmed-sota (13), substrate (11), census-neighbour (7), foundational (5), shape-anchor (4), recipe (3), closest-prior-art (2), speculative (1), grade-family-I (1), grade-family-U (1), grade-family-T (1), grade-family-N (1), grade-family-S (1), grade-family-R (1)
