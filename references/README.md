...
_Generated by `tools/refs.py build`. **106** entries · **64** on-disk · **51** facet-tagged. Full records: `references/index.json`. Query: `just refs <term>`._

- **topics:** grades (6), capability-safety (5), calculation (4), multishot (4), graded-types (3), effect-algebra (3), env-semantics (3), lr (3), wasmfx (3), surface-syntax (3), memory (3), parsing (2), agentic-proving (2), verified-semantics (2), effect-handlers (2), cbpv (2), conformance-profiles (2), compilation (1), counterexample (1), lemma-discovery (1), stm (1), verified-compilation (1), effects (1), module-system (1), verified-typechecker (1), iris (1)
- **roles:** frontier (15), substrate (9), confirmed-sota (9), census-neighbour (4), foundational (3), shape-anchor (2), recipe (1), speculative (1), grade-family-I (1), grade-family-U (1), grade-family-T (1), grade-family-N (1), grade-family-S (1), closest-prior-art (1), grade-family-R (1)
