...
_Generated by `tools/refs.py build`. **83** entries · **64** on-disk · **26** facet-tagged. Full records: `references/index.json`. Query: `just refs <term>`._

- **topics:** capability-safety (5), calculation (4), graded-types (3), env-semantics (3), lr (3), surface-syntax (3), effect-algebra (2), wasmfx (2), parsing (2), agentic-proving (2), counterexample (1), lemma-discovery (1), stm (1)
- **roles:** frontier (10), substrate (8), confirmed-sota (6), recipe (1), speculative (1)
