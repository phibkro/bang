...
- **topics:** capability-safety (5), calculation (4), graded-types (3), lr (3), effect-algebra (2), wasmfx (2), agentic-proving (2), tooling (2), surface-syntax (1), parsing (1), counterexample (1), lemma-discovery (1), stm (1)
- **roles:** substrate (9), frontier (8), confirmed-sota (4), recipe (1), speculative (1)
- **on-disk by hop:** adjacent (25), 1-kernel (14), 2-calcvm (9), 3-lr (7), 4-wasmfx (6), christiansen-darais-ma-final-pretty-printer.pdf (1), xie-schrijvers-hu-popl25-biparsers.pdf (1)
