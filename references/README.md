...
_Generated by `tools/refs.py build`. **103** entries · **64** on-disk · **48** facet-tagged. Full records: `references/index.json`. Query: `just refs <term>`._
...
- **roles:** frontier (15), substrate (9), confirmed-sota (6), census-neighbour (4), foundational (3), shape-anchor (2), recipe (1), speculative (1), grade-family-I (1), grade-family-U (1), grade-family-T (1), grade-family-N (1), grade-family-S (1), closest-prior-art (1), grade-family-R (1)
