...
_Generated by `tools/refs.py build`. **74** entries · **60** on-disk · **20** facet-tagged. Full records: `references/index.json`. Query: `just refs <term>`._

- **topics:** capability-safety (5), calculation (4), graded-types (3), lr (3), effect-algebra (2), wasmfx (2), agentic-proving (2), counterexample (1), lemma-discovery (1), stm (1)
- **roles:** frontier (8), substrate (7), confirmed-sota (4), speculative (1)
- **on-disk by hop:** adjacent (24), 1-kernel (14), 2-calcvm (9), 3-lr (7), 4-wasmfx (6)
