...
_Generated by `tools/refs.py build`. **73** entries · **59** on-disk · **19** facet-tagged. Full records: `references/index.json`. Query: `just refs <term>`._

- **topics:** capability-safety (5), calculation (4), graded-types (3), lr (3), effect-algebra (2), wasmfx (2), counterexample (1), agentic-proving (1), stm (1)
- **roles:** frontier (7), substrate (7), confirmed-sota (4), speculative (1)
- **on-disk by hop:** adjacent (23), 1-kernel (14), 2-calcvm (9), 3-lr (7), 4-wasmfx (6)
