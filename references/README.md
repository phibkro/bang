...
_Generated by `tools/refs.py build`. **75** entries · **61** on-disk · **21** facet-tagged. Full records: `references/index.json`. Query: `just refs <term>`._

- **topics:** capability-safety (5), calculation (4), graded-types (3), lr (3), effect-algebra (2), wasmfx (2), agentic-proving (2), surface-syntax (1), parsing (1), counterexample (1), lemma-discovery (1), stm (1)
- **roles:** frontier (8), substrate (7), confirmed-sota (4), recipe (1), speculative (1)
- **on-disk by hop:** adjacent (25), 1-kernel (14), 2-calcvm (9), 3-lr (7), 4-wasmfx (6)
