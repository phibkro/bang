...
_Generated by `tools/refs.py build`. **87** entries · **64** on-disk · **32** facet-tagged. Full records: `references/index.json`. Query: `just refs <term>`._

- **topics:** capability-safety (5), calculation (4), multishot (4), graded-types (3), effect-algebra (3), env-semantics (3), lr (3), wasmfx (3), surface-syntax (3), parsing (2), agentic-proving (2), effect-handlers (2), compilation (1), counterexample (1), lemma-discovery (1), stm (1), module-system (1)
- **roles:** frontier (15), substrate (9), confirmed-sota (6), recipe (1), speculative (1)
