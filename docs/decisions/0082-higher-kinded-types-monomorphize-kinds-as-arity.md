...
- **Status:** Proposed — scoped by the hktscope design spike (2026-07-07); manager-reviewed as sound (mono-additive finding grounded in code). Awaiting go-ahead + implementation (bite-3 Stage A). Finalize to Accepted as the tier lands.
- **Date:** 2026-07-07
