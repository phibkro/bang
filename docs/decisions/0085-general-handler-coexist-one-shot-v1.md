...
- **Status:** Proposed — design-first pass (2026-07-07), READ-ONLY on `Bang/`. This records the DESIGN + STAGING for the biggest post-MVP, spine-touching change; the IMPLEMENTATION is a later, staged, separately-approved effort. Nothing in `Bang/` is edited by this ADR.
- **Date:** 2026-07-07
