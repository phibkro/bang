...
## Q35–Q38 — migrated to the structured ledger

Q35–Q38 have migrated to `docs/notes/questions/` (OKF-shaped structured
ledger — one file per question, frontmatter-typed, ties validated). See the
generated `docs/notes/questions/INDEX.md` for the grouped index + tie graph.
Q1–Q34 remain above in this file (migration pending).
