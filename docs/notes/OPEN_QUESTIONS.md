...
- [Q32 — Memoization as a pure-function combinator: the `⊥`-row license, opt-in because space↔time is a resource EFFECT](#q32--memoization-as-a-pure-function-combinator-the--row-license-opt-in-because-spacetime-is-a-resource-effect)  · OPEN (post-v1; library over the kernel)
- [Q33 — Memory model: immutability + QTT + refcounting vs ownership/lifetimes; substrings, copies-vs-refs, the three axes](#q33--memory-model-immutability--qtt--refcounting-vs-ownershiplifetimes-substrings-copies-vs-refs-the-three-axes)  · OPEN (post-v1; ties Q27/Q30/Q31)
- [Q34 — Module-system + tooling SURFACE forks (file-vs-block · qualified-vs-open · visibility · the hashing boundary) — architecture pinned by ADR-0076](#q34--module-system--tooling-surface-forks-file-vs-block--qualified-vs-open--visibility--the-hashing-boundary--architecture-pinned-by-adr-0076)  · OPEN (decided when the module system is built)
...
## Q32 — Memoization as a pure-function combinator: the `⊥`-row license, opt-in because space↔time is a resource EFFECT  · OPEN (post-v1; library over the kernel)
...
## Q33 — Memory model: immutability + QTT + refcounting vs ownership/lifetimes; substrings, copies-vs-refs, the three axes  · OPEN (post-v1; ties Q27/Q30/Q31)
...
## Q34 — Module-system + tooling SURFACE forks (file-vs-block · qualified-vs-open · visibility · the hashing boundary) — architecture pinned by ADR-0076  · OPEN (decided when the module system is built)
...
## Q35 — Force ergonomics: auto-force a thunk-of-function at the call site; reserve visible `$` for meaningful observation  · OPEN (surface ergonomics; sugar, no kernel change)
...
## Q36 — Gradual correctness / prototyping mode: typed holes, run-with-warnings, the coarse-vs-fine escape-hatch gap  · OPEN (surface + tooling; the vague-spec / exploratory end of the gradient)
...
## Q37 — FFI as a typed EFFECT: the external-boundary seam (schema-declared contract · capability security · the road to OS/distributed)  · OPEN (northstar direction — the first interactive-program capability)
...
## Q38 — module ≟ trait ≟ effect ≟ capability: one interface+implementation construct, dialed by resumption grade?  · OPEN (deep unification; stress-test, don't decide a priori)
