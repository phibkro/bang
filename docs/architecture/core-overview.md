...
graph TD
  ...
  subgraph tier_Core["Core — IR · typing · KERNEL (the narrow waist)"]
    ...
    Backend_WasmEmit["Backend.WasmEmit<br/>1096L · fan-in 0"]
    ...
    Frontend_TypeCheck["Frontend.TypeCheck<br/>8013L · fan-in 0"]
