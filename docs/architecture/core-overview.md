...
graph TD
  ...
  subgraph tier_Core["Core — IR · typing · KERNEL (the narrow waist)"]
    ...
    Backend_WasmEmit["Backend.WasmEmit<br/>380L · fan-in 0"]
    ...
    Frontend_TypeCheck["Frontend.TypeCheck<br/>6050L · fan-in 0"]
