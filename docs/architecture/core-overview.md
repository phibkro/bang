...
graph TD
  ...
  subgraph tier_Core["Core — IR · typing · KERNEL (the narrow waist)"]
    ...
    Examples["Examples<br/>499L · fan-in 0"]
    Frontend_Annotate["Frontend.Annotate<br/>252L · fan-in 0"]
    Frontend_DiagCodes["Frontend.DiagCodes<br/>234L · fan-in 0"]
    Frontend_Diagnostics["Frontend.Diagnostics<br/>227L · fan-in 0"]
    Frontend_Format["Frontend.Format<br/>1086L · fan-in 0"]
    ...
    Frontend_Surface["Frontend.Surface<br/>3168L · fan-in 1"]
    ...
    Frontend_TypeCheck["Frontend.TypeCheck<br/>7658L · fan-in 0"]
...
| `Frontend.DiagCodes` | ? | 234 | 0 |
| `Frontend.Diagnostics` | ? | 227 | 0 |
| `Frontend.Format` | ? | 1086 | 0 |
| `Frontend.Lint` | ? | 213 | 0 |
