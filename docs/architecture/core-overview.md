...
graph TD
  ...
  subgraph tier_Core["Core — IR · typing · KERNEL (the narrow waist)"]
    ...
    Frontend_Format["Frontend.Format<br/>709L · fan-in 0"]
    ...
    Frontend_TypeCheck["Frontend.TypeCheck<br/>4225L · fan-in 0"]
    ...
    Witness_LawTest["Witness.LawTest<br/>555L · fan-in 0"]
