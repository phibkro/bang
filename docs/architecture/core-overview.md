...
graph TD
  ...
  subgraph tier_Core["Core — IR · typing · KERNEL (the narrow waist)"]
    ...
    Backend_WasmEmit["Backend.WasmEmit<br/>924L · fan-in 0"]
    ...
    Frontend_DiagCodes["Frontend.DiagCodes<br/>249L · fan-in 0"]
    ...
    Frontend_TypeCheck["Frontend.TypeCheck<br/>7958L · fan-in 0"]
