...
graph TD
  ...
  subgraph tier_Core["Core — IR · typing · KERNEL (the narrow waist)"]
    ...
    Frontend_Surface["Frontend.Surface<br/>1626L · fan-in 1"]
    ...
    Frontend_TypeCheck["Frontend.TypeCheck<br/>1322L · fan-in 0"]
