...
graph TD
  ...
  subgraph tier_Core["Core — IR · typing · KERNEL (the narrow waist)"]
    ...
    Frontend_Surface["Frontend.Surface<br/>1294L · fan-in 1"]
    ...
    Frontend_TypeCheck["Frontend.TypeCheck<br/>639L · fan-in 0"]
