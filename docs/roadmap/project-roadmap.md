...
| **now** | checked module exports carry owner-local declared public-law contracts and the external consumer includes them in validated fanout | a public law edit moves its owner and dependents even with no realization; private laws stay absent; merge-context churn and unexplained instance movement are fail-loud gates | keep law enforcement, actual skips/reuse, and semantic law equivalence unclaimed; then isolate lowered module identity/body/link constraints before any store |
