...
# The proof, machine/backend, and tooling/docs/examples role-lab harnesses build inside the exact-HEAD clones they verify.
#
...
batteries=(check-examples check-examples-env test-example-exit-status test-repl test-fmt test-check-json test-query \
           ...
           test-role-lab-frontend test-role-lab-kernel-proof test-role-lab-machine-backend test-role-lab-tooling-docs-examples test-compiled-dogfood test-bang-build)
