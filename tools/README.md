...
| [`test-host-authority.sh`](test-host-authority.sh) | `verify` | `Main.lean`, `std/Io.bang` | Explicit real-host authority, trusted bundled-service identity, Fs root containment, and complete record publication (#169) |
