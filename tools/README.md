...
| [`test-compiled-dogfood.sh`](test-compiled-dogfood.sh) | `verify` | `examples/calc`, `examples/json`, `examples/reactive-spreadsheet`, `examples/reactive-recomputation`, `examples/reactive-observation-reuse` | the --compiled DIFFERENTIAL gate for the dogfood programs (#135) |
