...
| [`test-compiled-dogfood.sh`](test-compiled-dogfood.sh) | `verify` | `examples/calc`, `examples/json`, `examples/reactive-spreadsheet` | the --compiled DIFFERENTIAL gate for the dogfood programs (#135) |
...
| [`test-query.sh`](test-query.sh) | `verify` | `examples/*/main.bang`, `examples/reactive-spreadsheet/Formulas.bang`, `examples/reactive-spreadsheet/expected-dependencies.json` | the non-interactive gate for `bang query <op>` (issue #80, the agent LSP as |
