...
| [`gen-reactive-workload.py`](gen-reactive-workload.py) | `fitness` | `examples/reactive-recomputation/Workload.bang`, `examples/reactive-observation-reuse/CachedWorkload.bang` | Generate deterministic uncached and observation-scoped reactive workloads |
| [`gen-reference.py`](gen-reference.py) | `fitness` | `docfacts/language.json`, `Bang/Frontend/Surface.lean`, `Bang/Core/IR.lean`, `Bang/Core/Fingerprint.lean`, `Bang/Core/SHA256.lean`, `Bang/Core/CompCodec.lean`, `Bang/Core/Semantics/Eval.lean`, `Bang/Frontend/TypeCheck.lean`, `Bang/Frontend/Query.lean`, `Bang/Backend/BodyArtifact.lean`, `Bang/Examples.lean`, `docs/reference/language.md` | Generate docs/reference/language.md — a DERIVATION of the code, never hand-maintained |
...
| [`test-initializer-census.sh`](test-initializer-census.sh) | `verify` | `Main.lean`, `Bang/Frontend/Query.lean`, `Bang/Frontend/TypeCheck.lean`, `examples/*/main.bang` | pin the syntax census, row stop conditions, and inert-contract probe |
