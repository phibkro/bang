...
| [`gen-reference.py`](gen-reference.py) | `fitness` | `docfacts/language.json`, `Bang/Frontend/Surface.lean`, `Bang/Core/IR.lean`, `Bang/Core/Fingerprint.lean`, `Bang/Core/Semantics/Eval.lean`, `Bang/Frontend/TypeCheck.lean`, `Bang/Frontend/Query.lean`, `Bang/Examples.lean`, `docs/reference/language.md` | Generate docs/reference/language.md — a DERIVATION of the code, never hand-maintained |
