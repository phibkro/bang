...
| [lattice-store](lattice-store/) | **the R3 lattice-core consumer probe** — the generic Lean core proves join-only laws; the BANG `Int/max` handler source is retained at ADR-0114's pure-computed-update wall, beside an independent statically refused CAS fixture | expected refusal |
